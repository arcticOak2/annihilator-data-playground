...
/**
 * Comprehensive tests for HiveScriptGenerator script generation. These tests verify the actual
 * generated scripts for different scenarios.
 */
class HiveScriptGeneratorTest {
  ...
  void testGenerateHiveScript_WithoutUDFs_ShouldGenerateBasicScript() throws SQLException {
    ...
    assertTrue(
        script.stream()
            .anyMatch(line -> line.contains("LOG_FILE=\"/tmp/hive-execution-abc123.log\"")));
