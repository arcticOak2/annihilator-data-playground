...
public interface ReconciliationMappingDAO {
    ...
    void createReconciliationMapping(String playgroundId, String leftTableId, String rightTableId, String map) throws SQLException;

    List<Reconciliation> findReconciliationMappingByPlaygroundId(String playgroundId) throws SQLException;
