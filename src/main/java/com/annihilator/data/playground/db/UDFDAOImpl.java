...
public class UDFDAOImpl implements UDFDAO {
  ...
  public void createUDF(UDF udf) throws SQLException {
    String sql =
        "INSERT INTO udfs (id, user_id, name, function_name, jar_s3_path, class_name, parameter_types, return_type, description, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  ...
  public List<UDF> getUDFsByUserId(String userId) throws SQLException {
    String sql =
        "SELECT id, user_id, name, function_name, jar_s3_path, class_name, parameter_types, return_type, description, created_at FROM udfs WHERE user_id = ?";
  ...
  public UDF getUDFById(String udfId) throws SQLException {
    String sql =
        "SELECT id, user_id, name, function_name, jar_s3_path, class_name, parameter_types, return_type, description, created_at FROM udfs WHERE id = ?";
