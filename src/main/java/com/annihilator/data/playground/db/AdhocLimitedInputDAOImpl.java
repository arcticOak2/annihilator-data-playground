...
public class AdhocLimitedInputDAOImpl implements AdhocLimitedInputDAO{
    ...
    @Override
    public void createAdhocLimitedInput(String run_id, String playground_id, LimitedRunRequest request) throws SQLException {

        String sql = "INSERT INTO adhoc_limited_input (run_id, playground_id, input_data, created_at) VALUES (?, ?, ?, ?)";
    ...
    public LimitedRunRequest getAdhocLimitedInputByRunId(String runId) throws SQLException {
        ...
        String sql = "SELECT input_data FROM adhoc_limited_input WHERE run_id = ? ORDER BY created_at DESC LIMIT 1";
