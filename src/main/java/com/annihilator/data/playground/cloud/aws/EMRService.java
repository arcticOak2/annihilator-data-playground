...
public interface EMRService {
  ...
  CompletableFuture<StepResult> submitTaskAndWait(
      String playgroundId, String taskId, String content, String taskType);
  ...
  static EMRService getInstance(AWSEmrConfig awsEmr, UDFDAO udfDAO, TaskDAO taskDAO) {
    ...
    EMRService emrService =
        new EMRServiceImpl(awsEmr, cloudFormationClient, emrClient, s3Service, udfDAO, taskDAO);
