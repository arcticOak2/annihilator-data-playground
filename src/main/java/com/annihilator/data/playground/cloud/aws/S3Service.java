...
public interface S3Service {
  ...
  /**
   * Lists files in an S3 directory and returns the first data file found (ignores Spark metadata
   * files)
   *
   * @param s3DirectoryPath The full S3 directory path (e.g., s3://bucket-name/path/to/directory/)
   * @return The full S3 path to the first data file found in the directory, or null if no data
   *     files found
   */
