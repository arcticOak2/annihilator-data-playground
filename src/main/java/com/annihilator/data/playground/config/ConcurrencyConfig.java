...
public class ConcurrencyConfig {
  ...
  @Min(
      value = 60000,
      message = "Playground execution grace period must be at least 60000ms (1 minute)")
  @Max(
      value = 1800000,
      message = "Playground execution grace period cannot exceed 1800000ms (30 minutes)")
  private long playgroundExecutionGracePeriod;

  @Min(
      value = 60000,
      message = "Playground max execution frequency must be at least 60000ms (1 minute)")
  @Max(
      value = 3600000,
      message = "Playground max execution frequency cannot exceed 3600000ms (1 hour)")
