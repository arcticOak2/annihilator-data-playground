...
/**
 * Script generator for Hive execution scripts with UDF support.
 * This class handles the dynamic generation of complete Hive execution scripts
 * including UDF setup (if any) and the main query execution.
 */
public class HiveScriptGenerator {

    /**
     * Generates a complete Hive execution script for a given task.
     ...
     */
    public static List<String> generateHiveScript(Task task, UDFDAO udfDAO, String playgroundId, String queryId, String uniqueId, String bucket, String date, String tempFile, String outputPath) throws SQLException {
        return generateHiveScript(task, udfDAO, playgroundId, queryId, uniqueId, bucket, "data-phantom", date, tempFile, outputPath);
    }
    
    public static List<String> generateHiveScript(Task task, UDFDAO udfDAO, String playgroundId, String queryId, String uniqueId, String bucket, String pathPrefix, String date, String tempFile, String outputPath) throws SQLException {
        ...
        script.add("LOG_S3_PATH=\"s3://" + bucket + "/" + pathPrefix + "/logs/" + date + "/hive-log-" + playgroundId + "-" + queryId + "-" + uniqueId + ".log\"");
        script.add("");
